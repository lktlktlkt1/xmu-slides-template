...
%   aspectratio=169   16:9   宽屏，会议/投影默认            ← 推荐
%   aspectratio=1610  16:10  部分笔记本 / 投影              ← 推荐
%   aspectratio=43    4:3    老式投影 / 教室白板            ← 推荐
...
\author[\ph{一作 et al.}]{\ph{论文全部作者（按论文署名顺序）}}
\institute[\ph{机构}]{\ph{团队所属单位}}
\setsource{\ph{会议 / 期刊}}{\ph{年份}}   % 论文来源；不需要可删除本行
\setdomains{\domaintag{\ph{领域1}}\domaintag{\ph{领域2}}\domaintag{\ph{领域3}}}
\setpresenter{\ph{汇报人}}
\setvenue{\ph{地点}}
\date{\ph{YYYY-MM-DD}}
